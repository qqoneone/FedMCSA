...
from FLAlgorithms.optimizers.fedoptimizer import pFedAToldOptimizer
from FLAlgorithms.users.userbase import User
import copy

# Implementation for pFedATold clients

class UserpFedATold(User):
    def __init__(self, device, numeric_id, train_data, test_data, model, batch_size, learning_rate,beta,lamda,
        ...
        self.optimizer = pFedAToldOptimizer(self.model.parameters(), lr=self.personal_learning_rate, lamda=self.lamda)
