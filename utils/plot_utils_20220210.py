...
def simple_read_data(alg):
    print(alg)
    hf = h5py.File("./resultsouradd20220205/"+'{}.h5'.format(alg), 'r')
...
def plot_summary_one_figure_mnist_Compare_Hyperlambda0(num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta,
    ...
    plt.savefig("./figures_temp/Hyperlambda_" + dataset.upper() + "Convex_Mnist_train.pdf", bbox_inches="tight")
    ...
    plt.savefig("./figures_temp/Hyperlambda_" + dataset.upper() + "Convex_Mnist_test.pdf", bbox_inches="tight")
...
def plot_summary_one_figure_mnist_Compare_HyperC0(num_users, loc_ep1, Numb_Glob_Iters, lamb, learning_rate, beta,
    ...
    # plt.ylim([0.05,  0.6]) # non convex-case
    # plt.ylim([0., 0.5])  # convex-case
    plt.savefig("./figures_temp/figure_HyperC_Loss_"+ dataset.upper() + "_" + titlename + ".pdf", bbox_inches="tight", pad_inches=0)
    # plt.savefig(dataset.upper() + "Non_Convex_Mnist_train_K.pdf", bbox_inches="tight")
    plt.figure(2, figsize=(5, 5))
    ax = plt.gca()
    ax.set_facecolor("gainsboro")  # whitesmoke gainsboro
    ...
    # plt.ylim([0.84,  0.98]) # non convex-case
    # plt.ylim([0.86, 1.0])  # Convex-case
    plt.savefig("./figures_temp/figure_HyperC_Acc_"+ dataset.upper() + "_" + titlename + ".pdf", bbox_inches="tight", pad_inches=0)
    # plt.savefig(dataset.upper() + "Non_Convex_Mnist_test_K.pdf", bbox_inches="tight")
    plt.close()
